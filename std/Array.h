...
constexpr static auto iota_array(T const offset = {})
{
    ...
    return Detail::integer_sequence_generate_array<T>(offset, MstdeIntegerSequence<T, N>());
}

}

using std::Array;
using std::iota_array;