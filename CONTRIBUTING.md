...
When commiting code to Hydra, please be sure the change(s) you wish to make are in line with the project vision. If you are unsure about this, open an issue, or start a talk in the Discord, so we can discuss it. If you are already confident it's a good fit, you can proceed to open a Pull Reqeust.

## Communication

Discord: [Hydra Discord](https://discord.gg/qZSYeNrzzA)
